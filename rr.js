...
function preload() {
    ...
    this.load.spritesheet('dude', 'assets/demon.png', { frameWidth: 32, frameHeight: 48 });
}
...
function create() {
    ...
    movingPlatform2 = this.physics.add.image(200, 250, 'ground');
    ...
    // this.physics.add.image(200, 200, 'star')
